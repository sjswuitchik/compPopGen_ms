...
|Athene cunicularia|[sample sheet](https://github.com/sjswuitchik/compPopGen_ms/blob/master/SRA/cleaned-metadata/Athene_cunicularia_sample_metadata.csv)|**running (Tim)**|wait|**changed ref dir to Genbank accession (GCA_003259725.1) for consistency with old run**|path|[doi](https://doi.org/10.1098/rspb.2018.0206)|used high coverage (8.7-fold to 42.5-fold in paper)|
