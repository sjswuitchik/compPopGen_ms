...
|Ficedula albicollis|[sample sheet](https://github.com/sjswuitchik/compPopGen_ms/blob/SRA/cleaned-metadata/Ficedula_albicollis_sample_metadata.csv)|In progress|Finish pipeline|run with release version of pipeline|`/n/holylfs05/LABS/informatics/Everyone/comppopgen_pipeline/_______`|
...
|Fundulus heteroclitus|[sample sheet](https://github.com/sjswuitchik/compPopGen_ms/blob/SRA/cleaned-metadata/Fundulus_heteroclitus_sample_metadata.csv)|In progress|Finish pipeline|run with release version of pipeline|`/n/holylfs05/LABS/informatics/Everyone/comppopgen_pipeline/_______`|
